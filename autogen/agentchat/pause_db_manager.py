...
class PauseDBManager:
    ...
    def upsert_agent_status(self, agent_id: str, agent_name: str, is_paused: bool = False, 
                           pause_message: Optional[str] = None) -> bool:
        """
    ...
    def set_agent_pause_state(self, agent_id: str, is_paused: bool, 
                             pause_message: Optional[str] = None) -> bool:
        """
